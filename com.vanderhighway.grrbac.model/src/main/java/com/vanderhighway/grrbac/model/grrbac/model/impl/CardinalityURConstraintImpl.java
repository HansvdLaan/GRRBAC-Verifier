...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cardinality UR Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.vanderhighway.grrbac.model.grrbac.model.impl.CardinalityURConstraintImpl#getBound <em>Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CardinalityURConstraintImpl extends UnaryRoleConstraintImpl implements CardinalityURConstraint {
	/**
	 ...
	 * @generated
	 */
	protected CardinalityURConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GRRBACPackage.Literals.CARDINALITY_UR_CONSTRAINT;
	}
	...
	public void setBound(Integer newBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GRRBACPackage.CARDINALITY_UR_CONSTRAINT__BOUND, oldBound, bound));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GRRBACPackage.CARDINALITY_UR_CONSTRAINT__BOUND:
				return getBound();
		}
